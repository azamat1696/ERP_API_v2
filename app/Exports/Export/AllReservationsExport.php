...
class AllReservationsExport implements FromCollection, WithStyles,WithHeadings, WithProperties,ShouldAutoSize,WithEvents
{
    ...
    {
        return DB::table('all_reservation_exports_v')->get();
    }
